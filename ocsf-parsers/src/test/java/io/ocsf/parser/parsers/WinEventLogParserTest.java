...
//    System.out.println(Json.format(event));
  ...
  public void parseCRLFEventTest() throws Exception
  {
    final String Event = "01/31/2022 04:51:46 PM\nLogName=Security\nEventCode=4634\n" +
        "EventType=0\nComputerName=SesWin2019DC1.SesTest.local\nSourceName=Microsoft Windows security auditing.\n" +
        "Type=Information\nRecordNumber=378587\nKeywords=Audit Success\nTaskCategory=Logoff\nOpCode=Info\n" +
        "Message=An account was logged off.\r\n\r\nSubject:\r\n\tSecurity ID:\t\tSESTEST\\SESWIN2019DC2$\r\n\t" +
        "Account Name:\t\tSESWIN2019DC2$\r\n\tAccount Domain:\t\tSESTEST\r\n\tLogon ID:\t\t0x44F8DC\r\n\r\n" +
        "Logon Type:\t\t\t3\r\n\r\nThis event is generated when a logon session is destroyed. " +
        "It may be positively correlated with a logon event using the Logon ID value. Logon IDs are only unique " +
