...
/**
 * The TranslatorsManager class responsible for managing a group of related event translators. The
 * class's primary responsibility is to handle a collection of translators, such as adding and
 * retrieving translators
 * <p>
