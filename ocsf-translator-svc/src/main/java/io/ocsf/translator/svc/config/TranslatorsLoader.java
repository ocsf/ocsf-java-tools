...
/**
 * TranslatorsLoader loads the translation rules found in the given <code>home</code> folder.
 */
public final class TranslatorsLoader
{
   ...
   */
  public static FuzzyHashMap<TranslatorsManager> load(final String path)
    throws IOException
  {
   ...
   * @throws IOException if the given <code>path</code> is invalid
   */
  public static FuzzyHashMap<TranslatorsManager> load(final Path path)
    throws IOException
  {
    ...
    final FuzzyHashMap<TranslatorsManager> acc =
      new FuzzyHashMap<>(getPathName(home));
