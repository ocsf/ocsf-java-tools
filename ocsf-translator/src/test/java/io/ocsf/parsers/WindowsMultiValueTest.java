...
{
  private static final String Data0 = "12/13/2021 10:12:55 PM\n" +
      "LogName=Security\n" +
      "EventCode=4661\n" +
      "EventType=0\n" +
      ...
      "\n" +
      "Subject :\n" +
      "\tSecurity ID:\t\tS-1-5-21-4033139579-163346244-2917651748-1011\n" +
      ...
      "\tObject Name:\tS-1-5-21-4033139579-163346244-2917651748-500\n" +
  ...
  static final String Data1 = "11/05/2021 03:17:42 AM\n" +
      ...
      "        Command Type = Cmdlet\n" +
      "        Script Name = D:\\Users\\tbrown-admin\\scripts\\New folder\\Updated\\Onboarding2.5.9\\Splunkonboard.ps1\n" +
      "        Command Path =\n" +
      "        Sequence Number = 136\n" +
  ...
  private static final String Data2 = "11/11/2021 09:49:53 PM\n" +
      "LogName=Microsoft-Windows-PowerShell/Operational\n" +
      "SourceName=Microsoft-Windows-PowerShell\n" +
      "EventCode=4103\n" +
      "EventType=4\n" +
  ...
  private static final String Data3 = "12/13/2021 09:48:19 PM\n" +
      "LogName=Security\n" +
      "EventCode=4661\n" +
      "EventType=0\n" +
      "ComputerName=SesTestWin2019DC.SesTestDomain.local\n" +
  ...
  private static final String Data4 = "01/07/2022 12:06:59 PM\n" +
      "LogName=Security\n" +
      "EventCode=4672\n" +
      "EventType=0\n" +
  ...
  {
    final WinMultiLineParser parser = new WinMultiLineParser(data);
