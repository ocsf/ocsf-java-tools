...
public class CEFParserTest
{
  ...
  {
    parse("CEF:0|Check Point|SmartDefense|Check Point|IPS|Heimdal KDC ASN1 DER Length Denial of Service|5|act=Detect cp_severity=Medium cnt=69 cs1Label=Threat Prevention Rule Name cs2Label=Protection ID cs2=asm_dynamic_prop_AMSN20180109_01 cs3Label=Protection Type cs3=IPS cs4Label=Protection Name cs4=Heimdal KDC ASN1 DER Length Denial of Service cs4Label=Threat Prevention Rule ID cs4=REDACTED deviceDirection=1 flexNumber1Label=Confidence flexNumber1=3 flexNumber2Label=Performance Impact flexNumber2=3 flexString2Label=Attack Information flexString2=Heimdal KDC ASN1 DER Length Denial of Service in=0 msg=Web Server Enforcement Violation out=0 rt=1591186503000 spt=47298 dpt=88 Signature=CVE-2017-17439 cs4Label=Threat Prevention Rule ID");
  }
}