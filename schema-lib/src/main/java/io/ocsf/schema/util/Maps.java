...
public final class Maps
{
  ...
  public static final <T> T typecast(final Object obj) {return (T) obj;}
  ...
  public static final void put(final Map<String, Object> map, final String name, final Object value)
  {
   ...
   */
  public static final Object putIn(
  ...
  public static final void putIn(
      final Map<String, Object> map, final String path, final Object value)
  {
    if (value != null)
    {
  ...
  public static final <T> T get(final Map<String, Object> data, final String name)
  {
    return data != null ? typecast(data.get(name)) : null;
  }

  public static final <T> T get(final Map<String, Object> data, final String name, final T defaultValue)
  {
    if (data != null)
    {
   ...
   * path
   */
  public static final Object getIn(final Map<String, Object> map, final String... path)
  {
   ...
   * the path
   */
  public static final Object removeIn(final Map<String, Object> map, final String path)
  {
    // handle keys with dots
  ...
  private static final Object getNested(Map<String, Object> map, final String[] path)
  {
  ...
  private static final Object remove(Map<String, Object> map, final String[] keys)
  {
