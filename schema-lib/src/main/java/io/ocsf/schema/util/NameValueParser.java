...
public final class NameValueParser
{
   ...
   */
  public static final Map<String, Object> parse(final String text) throws ParserException
  {
  ...
  public final Map<String, Object> parse() throws ParserException
  {
  ...
  private final String value() throws ParserException
  {
    pos = skip(buf, pos, len);
   ...
   */
  private final String text() throws ParserException
  {
    sb.setLength(0);
  ...
  private static final int separator(final char[] buf, final int pos, final int len)
  {
    for (int i = pos; i < len; ++i)
    {
