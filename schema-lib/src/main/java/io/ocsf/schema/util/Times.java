...
public final class Times
{
  ...
  public static final String currentIso8601Time()
  {
    return toIso8601String(OffsetDateTime.now());
  }

  public static final String toIso8601String(final long time)
  {
    return toIso8601String(accessor(time));
  }

  public static final String toIso8601String(final TemporalAccessor date)
  {
    return formatter.format(date);
  }

  public static final long parseTime(final String value)
  {
  ...
  public static final long parse(final String arg)
  {
  ...
  private static final TemporalAccessor parseBest(final String text)
  {
  ...
  private static final long parseLocalTime(final String value)
  {
  ...
  private static final TemporalAccessor accessor(final long time)
  {
