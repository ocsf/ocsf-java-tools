...
public class EventServiceTest
{
  ...
  private static final String XmlWinEvent = "<Event xmlns=\"http://schemas.microsoft" +
  ...
  private static final String BadXmlWinEvent = "<Event xmlns=\"http://schemas.microsoft" +
    ".com/win/2004/08/events/event\">\n" +
    "   <System>\n" +
    "      <Provider Name=\"Microsoft-Windows-Security-Auditing\" " +
    "Guid=\"{54849625-5478-4994-A5BA-3E3B0328C30D}\" />\n" +
  ...
  private static final String VeryBadXmlWinEvent = "<Event>\n" +
    "   <System>\n" +
    "      <EventID>1234</EventID>\n" +
    "      <Version>0</Version>\n" +
    "      <Level>0</Level>\n" +
    ...
    try
    {
      service.process(
        FMap.<String, Object>b()
          .p(RawEvent.SOURCE_TYPE, XmlWinEventLogParser.SourceType));
    }
    catch (final TranslatorException e)
    {
  ...
  public void testUnsupportedSourceType()
  {
    ...
    try
    {
      service.process(
        FMap.<String, Object>b()
          .p(RawEvent.SOURCE_TYPE, WinEventLogParser.SourceType));
    }
    catch (final TranslatorException e)
    {
  ...
  public void testUnsupportedEvent()
  {
    try
    {
      service.process(
        FMap.<String, Object>b()
          .p(RawEvent.SOURCE_TYPE, XmlWinEventLogParser.SourceType)
          .p(RawEvent.RAW_EVENT, BadXmlWinEvent));
    }
    catch (final TranslatorException e)
    {
  ...
  public void testBadFormatEvent()
  {
    try
    {
      service.process(
        FMap.<String, Object>b()
          .p(RawEvent.SOURCE_TYPE, XmlWinEventLogParser.SourceType)
          .p(RawEvent.RAW_EVENT, VeryBadXmlWinEvent));
    }
    catch (final TranslatorException e)
    {
  ...
  public void testXmlWinEvent()
  {
    try
    {
      final Map<String, Object> translated = service.process(
        FMap.<String, Object>b()
          .p(RawEvent.SOURCE_TYPE, XmlWinEventLogParser.SourceType)
          .p(RawEvent.RAW_EVENT, XmlWinEvent));
