...
public final class Transformer
{
    ...
    final Path home, final JsonReader reader, final Map<String, Object> map) throws IOException
  {
...

    {
      ...
      {
        @Override
        public final Map<String, Object> apply(final Map<String, Object> data)
        {
        ...
        @Override
        public final boolean hasPredicate()
        {
  ...
  private static DataTranslator buildDataTranslator(
    final Map<String, Object> parser, final Function<io.ocsf.schema.util.Parser, DataTranslator> builder)
  {
  ...
  private static final Collection<Map<String, Object>> readRules(
    final Path home, final JsonReader reader, final Map<String, Object> map) throws IOException
  {
  ...
  static final Map<String, Object> apply(final List<Tuple<String, Rule>> rules, final Map<String,
    Object> data)
  {
    return apply(rules, data, new HashMap<>());
  }

  static final Map<String, Object> apply(
      ...
      if (predicate == null || predicate.test(data))
      {
        ...
        if (value != null)
        {
          if (type != null)
          {
            ...
            if (!Fingerprint.put(translated, type, value, key))
            {
  ...
  static final Predicate<Map<String, Object>> compile(final String when) throws InvalidExpressionException
  {
    return condition(ExpressionParser.parse(when));
  }

  private static final Predicate<Map<String, Object>> condition(final Tree node)
  {
    return data -> Evaluator.evaluate(node, key -> Maps.getIn(data, key));
  }

  private static final Object defaultValue(final String type, final Object value)
  {
    if (type != null)
    {
  ...
  private static final Object typecast(final Object o, final String type)
  {
  ...
  private static final Object toInt(final Object o)
  {
  ...
  private static final Object timestamp(final Object value)
  {
  ...
  private static final Object iso8601Time(final Object value)
  {
    if (value instanceof String)
    {
      try
