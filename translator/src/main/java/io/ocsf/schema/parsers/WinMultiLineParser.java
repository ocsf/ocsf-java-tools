...
/**
 * Windows multiline event parser. The parser grammar is:
 *
 * <pre>
...
public final class WinMultiLineParser
{
  ...
  public WinMultiLineParser(final String text)
  {
  ...
  public Map<String, Object> parse(final Map<String, Object> event)
  {
