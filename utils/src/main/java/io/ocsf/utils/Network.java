...
public final class Network implements Comparable<Network>
{
  ...
  private static final int parse(final String addr, final int length)
  {
    int dots        = 0;
    int numOfDigits = 0;
    int n           = 0;
  ...
  private static final void getChars(int i, int index, final char[] buf)
  {
    do
    {
  ...
  private static final String toString(int a)
  {
